...
interface CharSequence
{
   ...
   *
   * @return  int - the number of <code>char</code>s in this sequence
   */
public function length();
   ...
   * value is returned.
   *
   * @param   $index   int - the index of the <code>char</code> value to be returned
   *
   * @return  String the specified <code>char</code> value
   *
